...
import { AnyMediaMessageContent, AnyMessageContent, MediaGenerationOptions, MessageContentGenerationOptions, MessageGenerationOptions, MessageGenerationOptionsFromContent, MessageUserReceipt, WAMessage, WAMessageContent, WAProto } from '@whiskeysockets/baileys/lib/Types';
import { ILogger } from '@whiskeysockets/baileys/lib/Utils/logger';
import { MediaDownloadOptions } from '@whiskeysockets/baileys/lib/Utils/messages-media';
/**
...
export declare const generateLinkPreviewIfRequired: (text: string, getUrlInfo: MessageGenerationOptions["getUrlInfo"], logger: MessageGenerationOptions["logger"]) => Promise<import("@whiskeysockets/baileys/lib/Types").WAUrlInfo | undefined>;
