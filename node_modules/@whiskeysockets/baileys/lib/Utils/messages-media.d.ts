...
import { DownloadableMessage, MediaConnInfo, MediaDecryptionKeyInfo, MediaType, SocketConfig, WAMediaUpload, WAMediaUploadFunction, WAMessageContent } from '@whiskeysockets/baileys/lib/Types';
import { BinaryNode } from '@whiskeysockets/baileys/lib/WABinary';
...
export declare const decodeMediaRetryNode: (node: BinaryNode) => {
    key: import("@whiskeysockets/baileys/lib/Types").WAMessageKey;
    media?: {
